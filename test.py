...
from datasets_tun.dataset_synapse import Synapse_dataset
from utils import test_single_volume, test_single_image_white_mold
...
from datasets_tun.dataset_white_mold import WhiteMold_dataset
